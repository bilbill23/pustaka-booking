    ...
    <div class="row">
        <div class="col-lg-9">
            ...
            <div class="form-group row justify-content-end">
                <div class="col-sm-10">
                    <button type="submit" class="btn btn-outline-info"><i class="fas fa-pencil-alt"></i> Ubah</button>
                    <button class="btn btn-outline-secondary" onclick="window.history.go(-1)"><i class="far fa-caret-square-left"></i> Kembali</button>
                </div>
            </div>
            </form>
        </div>
